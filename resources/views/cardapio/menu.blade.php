...
<body class="sub_page">
  ...
  <div class="hero_area">
    <div class="bg-box">
      <img src="images/hero-bg.jpg" alt="aa">
    </div>
  ...
  <section class="food_section layout_padding">
    <div class="container">
      ...
      <ul class="filters_menu">
        ...
        <li data-filter=".lanche">Lanches</li>
        <li data-filter=".pastel">Pasteis</li>
        <li data-filter=".salgado">Mini Salgados</li>
      ...
      <div class="filters-content">
        <div class="row grid">
          ...
          <div class="col-sm-6 col-lg-4 all lanche">
            <div class="box">
              <div>
                <div class="img-box">
